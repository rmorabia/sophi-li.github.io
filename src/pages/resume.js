    ...
    <div className={styles.container}>
      ...
      <div className={styles.resumeContainer}>
        <section>
          ...
          <p>Actively interviewing for software engineering roles.</p>
          <p>
        ...
        <section>
          ...
          <ul>
            <li>
              ...
              process to achieve 83% onboarding satisfaction score from 9 new
              team members
            </li>
            <li>
          ...
          <ul>
            <li>
              Developed a customized Salesforce instance for Partnership’s team
              to track fundraising pipeline
            </li>
            <li>
              Initiated and implemented knowledge management system across
              entire organization through a feedback driven process
            </li>
          </ul>
          ...
          <ul>
            <li>
              Built and maintained a database of over 5,000+ partners and
